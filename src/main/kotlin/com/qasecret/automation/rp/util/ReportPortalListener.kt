package com.qasecret.automation.rp.util
...
class ReportPortalListener : TestListener, ProjectListener {
    companion object {
        private const val SUITE_NAME = "Test Suite"
        private const val DEFAULT_RETRY_ATTEMPTS = 3
        private const val RETRY_DELAY_MS = 1000L
        private val logger = LoggerFactory.getLogger(ReportPortalListener::class.java)
    }
